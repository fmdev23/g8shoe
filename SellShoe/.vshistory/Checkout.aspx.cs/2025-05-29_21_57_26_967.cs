    ...
    public partial class Checkout : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                // Gán dữ liệu cho các control server
                lblOrderTitle.Text = checkout.Title;
                lblOrderTitle2.Text = checkout.Title;
                imgOrderProduct.ImageUrl = checkout.Image;
                lblOrderSize.Text = checkout.Size;
                lblOrderQuantity.Text = checkout.Quantity.ToString();
                lblOrderPrice.Text = ((decimal)checkout.Price).ToString("N0") + " VND";
                lblOrderTotal.Text = ((decimal)checkout.Price * checkout.Quantity).ToString("N0") + " VND";
            }
        }
