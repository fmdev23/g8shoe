    ...
    <form id="form1" runat="server">
            ...
            <div class="payment-form-container">
                ...
                <div id="payment-form">
                    ...
                    <div class="form-group promo-group">
                        <asp:TextBox ID="txtPromoCode" runat="server" CssClass="form-control" placeholder="Mã giảm giá" />
                        <asp:Button ID="btnApplyPromo" runat="server" Text="Áp dụng" CssClass="apply-button" OnClick="btnApplyPromo_Click" UseSubmitBehavior="false" />
                    </div>
                    ...
                    <div class="summary-items">
                        <div class="summary-item">
                            <div class="item-details">
                                ...
                                <p class="item-quan">Số lượng: 40</p>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                document.querySelector(".item-quan").textContent = "Số lượng: " + qty;
