            ...
            <div class="order-summary-container">
                <div class="order-summary">
                    <div class="summary-header">
                        <p>Đang thanh toán,</p>
                        <h2>
                            <asp:Label ID="lblOrderTitle" runat="server" />
                        </h2>
                    </div>
                    ...
                    <div class="summary-items">
                        <div class="summary-item">
                            <div class="item-details">
                                <asp:Image ID="imgOrderProduct" runat="server" Width="200" Height="200" />
                                <h3>
                                    <asp:Label ID="lblOrderTitle2" runat="server" />
                                </h3>
                                <h4 class="item-meta">Size: <asp:Label ID="lblOrderSize" runat="server" /></h4>
                                <h4 class="item-quan">Số lượng: <asp:Label ID="lblOrderQuantity" runat="server" /></h4>
                                <h4 class="item-price"><asp:Label ID="lblOrderPrice" runat="server" /></h4>
                            </div>
                        </div>
                    </div>
