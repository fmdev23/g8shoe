            ...
            <div class="order-summary-container">
                <div class="order-summary">
                    <div class="summary-header">
                        <p>Đang thanh toán,</p>
                        <h2><asp:Literal ID="litProductTitle" runat="server" /></h2>
                    </div>
                    ...
                    <div class="summary-items">
                        <div class="summary-item">
                            <div class="item-details">
                                ...
                                <h4 class="item-meta">Size: <asp:Literal ID="litSize" runat="server" /></h4>
                                <h4 class="item-quan">Số lượng: <asp:Literal ID="litQuantity" runat="server" /></h4>
                                <h4 class="item-price"><asp:Literal ID="litPrice" runat="server" /></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="summary-total">
                        <p>Tổng cộng</p>
                        <p class="total-amount"><asp:Literal ID="litTotal" runat="server" /></p>
                    </div>
                </div>
            </div>
        </div>
