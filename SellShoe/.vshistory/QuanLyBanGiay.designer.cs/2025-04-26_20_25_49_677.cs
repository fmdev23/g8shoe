...
namespace SellShoe
{
    ...
    partial void Deletetb_ContactPeople(tb_ContactPeople instance);
        ...
        public QuanLyBanGiayDataContext() : base("THINKPADX1\\SQLSEVER;Initial Catalog=WebBanGiay;Integrated Security=True;Encrypt=False;TrustServerCertificate=True", mappingSource)
        {
            OnCreated();
        }
