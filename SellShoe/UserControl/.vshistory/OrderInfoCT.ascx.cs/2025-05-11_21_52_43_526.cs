            ...
            if (order != null)
            {
                ...
                if (orderDetail != null)
                {
                    ...
                    if (product != null)
                    {
                        ...
                        lblPayment.Text = $"Thanh toán: {order.TotalAmount.ToString("N0").Replace(",", ".")} đ khi nhận hàng";
        ...
        protected void btnCancelOrder_Click(object sender, EventArgs e)
        {
            if (ViewState["CurrentOrderID"] != null)
            {
                ...
                if (order != null)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "alertRedirect", "alert('Đơn hàng đã được hủy thành công.'); window.location.href='Product.aspx';", true);
