...
<section id="hero" runat="server" style='background-image: url(<%= banner.BackgroundImage %>)'>
    <h4><%= banner.HeadingH4 %></h4>
    <h2><%= banner.HeadingH2 %></h2>
    <h1><%= banner.HeadingH1 %></h1>
...
<section id="feature" class="section-p1">
    ...
    <% foreach (var item in listFT)
        { %>
        <div class="fe-box">
            <img src="../img/features/<%= item.ImgFeature %>" alt="">
...
<section id="product-new" class="section-p1 product-section">
    ...
    <div class="pro-container">
        ...
        <div class="pro" data-category="<%= listSP[i].ProductCategoryId%>">
            <img src='<%="../img/products/" + listSP[i].Image %>' alt="">
            <div class="des">
