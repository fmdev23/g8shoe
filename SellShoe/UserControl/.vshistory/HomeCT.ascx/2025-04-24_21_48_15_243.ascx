...
<section id="product1" class="section-p1">
    ...
    <div class="filter-tabs">
        ...
        <button class="filter-tab" data-category="men">NAM</button>
        <button class="filter-tab" data-category="women">NỮ</button>
        <button class="filter-tab" data-category="accessories">PHỤ KIỆN</button>
    </div>
    ...
    <div class="pro-container">
        ...
        <div class="pro" data-category="<% for(int i = 0; i<) %>">
            <img src='<%="../img/products/" + listSP[i].Image %>' alt="">
            <div class="des">
