...
<section id="page-header" class="contact-header" style="background-image: url(../img/banner/2.png);">
    ...
    <p>Gửi cho chúng tôi trải nghiệm mua sắm của bạn. <br />Chúng tôi sẽ ghi nhận</p>
...
<section id="form-details">
    <div class="submit_form">
        ...
        <asp:TextBox ID="txtContactEmail" runat="server" placeholder="Email" CssClass="form-control" required="required"></asp:TextBox>
        <asp:TextBox ID="txtContactSubject" runat="server" placeholder="Chủ đề" CssClass="form-control" required="required"></asp:TextBox>
        <asp:TextBox ID="txtContactContent" runat="server" TextMode="MultiLine" placeholder="Nội dung" CssClass="form-control" Rows="5" required="required"></asp:TextBox>
