...
<section id="contact-details" class="section-p1">
    ...
    <div class="map">
        <iframe src="
            https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d66380.16296303923!2d105.71628472561622!3d10.034268917924626!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0629f6de3edb7%3A0x527f09dbfb20b659!2zQ-G6p24gVGjGoSwgTmluaCBLaeG7gXUsIEPhuqduIFRoxqEsIFZp4buHdCBOYW0!5e1!3m2!1svi!2s!4v1744644244119!5m2!1svi!2s" width="600" height="450" style="border: 0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
...
<section id="form-details">
    <div class="submit_form">
        ...
        <asp:Button ID="btnSubmit" runat="server" Text="Xác nhận gửi" CssClass="normal" OnClick="btnSubmit_Click"/>
    ...
    <div class="people">
        ...
        <%for (int i = 0; i < listInfo.Count; i++)
            { %>
        <div>
            <img src='<%=listInfo[i]. %>' alt="">
            <p>
                <span>Trần Ngọc Nhung</span>Lead
                <br>
                SDT: 0974387573
                <br>
        ...
        <div>
            ...
            <p>
                <span>Nguyễn Hoàng Kiệt</span>Design FrontEnd
                <br>
                SDT: 0974387573
                <br>
                Email: contact@gmail.com
        ...
        <div>
            ...
            <p>
                <span>Nguyễn Cảnh Bằng</span>Design Database
                <br>
                SDT: 0974387573
                <br>
                Email: contact@gmail.com
