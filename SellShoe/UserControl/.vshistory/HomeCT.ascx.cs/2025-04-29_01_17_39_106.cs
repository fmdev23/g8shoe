...
namespace SellShoe.UserControl
{
    public partial class Home : System.Web.UI.UserControl
    {
        ...
        {
            int fullStars = (int)Math.Floor(averageRating); // số sao đầy
            bool halfStar = (averageRating - fullStars) >= 0.5; // có nửa sao không
            int emptyStars = 5 - fullStars - (halfStar ? 1 : 0); // còn lại là sao rỗng
