...
namespace SellShoe.UserControl
{
    public partial class Home : System.Web.UI.UserControl
    {
        ...
        public static tb_Banner banner = new tb_Banner(); //banner
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (banner != null && !string.IsNullOrEmpty(banner.BackgroundImage))
            {
                hero.Attributes["style"] = $"background-image: url('{banner.BackgroundImage}')";
            }
        }

        // Load banner
        void loadBanner() {
            banner = db.tb_Banners.FirstOrDefault(b => b.IsActive == true);
        }
