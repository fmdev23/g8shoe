...
namespace SellShoe.UserControl
{
    public partial class Home : System.Web.UI.UserControl
    {
        ...
        public static List<tb_Product> listSPNew = new List<tb_Product>(); //sản phẩm
        ...
        void LoadNewProducts()
        {
            ...
            var newProducts = db.tb_Products
                                ...
                                .Take(10) // Lấy 12 sản phẩm mới nhất, có thể thay đổi số lượng
                                .ToList();

            listSPNew = newProducts; // Cập nhật lại listSP để hiển thị sản phẩm mới nhất
        }
