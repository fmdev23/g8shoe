...
<section id="prodetails" class="section-p1">
    ...
    <div class="single-pro-details">
        ...
        <form id="orderForm" method="post" action="sproductct.ascx" runat="server">
...
<script>
    ...
    btnOrderClient.addEventListener('click', (e) => {
        ...
        // Gửi dữ liệu vào form ẩn
        document.getElementById('hfSelectedSize').value = selectedSize;
        document.getElementById('hfQuantity').value = qtyValue.textContent;

        // Submit form ẩn ASP.NET
