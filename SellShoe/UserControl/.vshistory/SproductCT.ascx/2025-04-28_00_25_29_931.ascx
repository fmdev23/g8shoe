...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('submitReviewBtn').addEventListener('click', function () {
            ...
            var productId = CURRENT_PRODUCT_ID; // ID sản phẩm (bạn lấy từ QueryString cũng được)
            ...
            // Gửi về server dùng XMLHttpRequest
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'SubmitReview.aspx', true);
            ...
            xhr.onload = function () {
                if (xhr.status === 200) {
                    ...
                    if (result.success) {
                        ...
                        // Tạo nhanh 1 review mới
                        var newReviewHTML = `
                        <div class="review-item">
                            <div class="review-avatar"></div>
                            <div class="review-content">
                                <p class="review-date">${result.CreatedAt}</p>
                                <p class="review-name">${reviewerName}</p>
                                <div class="review-stars">
