    ...
    <div class="pro-container">
        ...
        <div class="pro">
            <a href="sproduct.aspx?id=<%= listSP[i].id %>">
                ...
                <a href="#"><i class="fab fa-amazon-pay cart"></i></a>
        </div>
...
<script>
    ...
    const orderBtn = document.querySelector('.add_to_cart_button a');
    ...
    orderBtn.addEventListener('click', function (e) {
        ...
        //const url = `checkout.aspx?id=${encodeURIComponent(productId)}&size=${encodeURIComponent(selectedSize)}&qty=${encodeURIComponent(quantity)}&img=${encodeURIComponent(imageUrl)}&title=${encodeURIComponent(title)}&price=${encodeURIComponent(price)}`;

        window.location.href = `checkout.aspx?productId=${productId}&price=${price}&quantity=${quantity}&size=${selectedSize}`;
