                            ...
                            <div class="review-form">
                                ...
                                <div class="review-form-container">
                                    <div class="form-group">
                                        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Placeholder="Tên của bạn" required="required"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" Placeholder="Đánh giá của bạn" TextMode="MultiLine" Rows="3"></asp:TextBox>
                                    </div>

                                    <asp:Button ID="Button1" runat="server" Text="Gửi đánh giá"
                                        CssClass="submit-btn" OnClick="btnSubmitReview_Click" UseSubmitBehavior="true" />
                                </div>
                            </div>
                        </div>
                    </ContentTemplate>
...
<script type="text/javascript">
    ...
    function showSuccessToast() {
        Swal.fire({
            ...
            timer: 5000,
            didClose: () => {
                // After toast is closed, ensure the review list is up to date
                updateReviewList();
            }
        });
    }
