...
<!-- Gán ProductId hiện tại -->
<script>
    var CURRENT_PRODUCT_ID = <%= sanPham.id %>;
</script>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('submitReviewBtn').addEventListener('click', function () {
                    ...
                    if (result.success) {
                        ...
                        <div class="review-item">
                            ...
                            <div class="review-content">
                                ...
                                <div class="review-stars">${generateStars(selectedRating)}</div>
            ...
            xhr.send(
                'ProductId=' + encodeURIComponent(CURRENT_PRODUCT_ID) +
