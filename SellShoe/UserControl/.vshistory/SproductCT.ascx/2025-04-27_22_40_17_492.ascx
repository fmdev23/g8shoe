...
<section id="prodetails" class="section-p1">
    ...
    <div class="single-pro-details">
        ...
        <div class="price-box">
            <span class="old-price"><%= sanPham != null ? ((int)sanPham.PriceSale).ToString("N0") + " VND" : " VND"%></span>
            <span class="new-price"><%= sanPham != null ? ((int)sanPham.PriceSale).ToString("N0") + " VND" : " VND"%></span>
        </div>
