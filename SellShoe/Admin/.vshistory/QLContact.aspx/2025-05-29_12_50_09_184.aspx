        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                document.addEventListener('click', function (e) {
                    const btn = e.target.closest('.delete-feedback'); // tìm phần tử cha gần nhất có class này
                    if (!btn) return;
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            const eventTarget = btn.name || btn.id;
                            console.log('Trigger postback: ', eventTarget);
                            console.log("Clicked delete button", btn);  // Kiểm tra JS có chạy không
