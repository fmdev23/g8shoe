            ...
            document.addEventListener('DOMContentLoaded', function () {
                document.querySelectorAll('.delete-feedback').forEach(function (btn) {
                    btn.addEventListener('click', function (e) {
                        e.preventDefault(); // Ngăn postback mặc định
                        const realBtn = this;
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                // Lấy ID của LinkButton (nó chính là tên dùng cho __doPostBack)
                                const eventTarget = realBtn.getAttribute('id').replace(/_/g, '$');
