...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.querySelectorAll(".action-cell .action-btn").forEach(btn => {
                btn.addEventListener("click", function (e) {
                    const parent = this.closest(".action-menu");
                    ...
                    categoryId.value = id;
                    txtTitle.value = cells[1].innerText.trim();
                    txtDescription.value = cells[2].innerText.trim();
                    txtAlias.value = cells[3].innerText.trim();
            ...
            document.getElementById("saveProductBtn").addEventListener("click", function () {
                ...
                fetch("ProductCategory.aspx/UpdateCategory", {
                    method: "POST",
                    headers: {
