        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card">
                <div class="card-header">
                    ...
                    <div class="card-value">4.235.353.457</div>
                </div>
            ...
            <div class="dashboard-card">
                <div class="card-header">
                    ...
                    <div class="card-value">2350 KH</div>
                </div>
                <div class="chart-container">
            ...
            <div class="dashboard-card">
                <div class="card-header">
                    <div>
                        <h3>Đơn hàng</h3>
                        <p class="subtitle">tổng cộng: 736.583.000</p>
                    </div>
                    <div class="card-value">224643</div>
                </div>
                <div class="progress-container">
                    <p class="progress-label">266 Left</p>
                ...
                <div class="recent-orders-table-container">
                    <table class="recent-orders-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><%=listOD[i].Code%></td>
                                <td><%=listOD[i].CreatedDate %></td>
                                <td><%=listOD[i].TotalAmount %></td>
