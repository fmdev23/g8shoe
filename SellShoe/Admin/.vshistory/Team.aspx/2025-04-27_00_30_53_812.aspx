            ...
            <table class="products-table">
                ...
                <tbody id="productsTableBody">
                    ...
                    <tr>
                        ...
                        <th>
                            <img src="<%= listTeam[i].Avatar %>" alt="Avatar" width="50"></th>
                        <th class="action-cell">
                            <button class="edit-btn" data-id="<%= listTeam[i].Id %>">
                                <i class="fad fa-edit"></i>Sửa
                            </button>
                            <button class="delete-btn" data-id="<%= listTeam[i].Id %>">
