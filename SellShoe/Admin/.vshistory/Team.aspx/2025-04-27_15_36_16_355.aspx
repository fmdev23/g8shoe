                ...
                <div class="modal-body">
                    <form id="memberForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="uploadAvatarFile" accept="image/*" />
                            <button type="button" id="uploadAvatarBtn">Tải ảnh lên</button>
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.getElementById("uploadAvatarBtn").addEventListener("click", function () {
                const fileInput = document.getElementById("uploadAvatarFile");
                ...
                fetch("Team.aspx/UploadAvatar", {
                    method: "POST",
                    body: formData
                })
                    .then(response => response.text()) // Vì server trả về string
                    .then(url => {
                        if (url) {
                            document.getElementById("txtAvatarUrl").value = url;
                            document.getElementById("previewAvatar").src = url;
                            alert("Tải ảnh thành công!");
                        } else {
                            alert("Lỗi tải ảnh! Kiểm tra lại file ảnh.");
                        }
                    })
