                ...
                <div class="modal-body">
                    <form id="memberForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="txtAvatarUrl" />
                            <img id="previewAvatar" src="" alt="Preview" style="width: 80px; height: 80px; margin-top: 10px;" />
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.getElementById("saveMemberBtn")?.addEventListener("click", function () {
                ...
                const avatar = document.getElementById("txtAvatarUrl").value; // lấy từ hidden field
            ...
            document.getElementById("fileAvatar").addEventListener("change", function () {
                ...
                fetch("Team.aspx/UploadAvatar", {
                    ...
                    .then(data => {
                        if (data.d) {
                            document.getElementById("txtAvatarUrl").value = data.d;
                            document.getElementById("previewAvatar").src = data.d;
                        } else {
