...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-card">
        <div class="card-header">
            ...
            <div class="header-actions">
                <asp:Button ID="btnShowModal" runat="server" CssClass="add-product-btn" Text="Thêm thành viên" OnClientClick="showModal(); return false;" />
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-actions">
                        ...
                        <asp:Button ID="btnSaveMember" runat="server" Text="Lưu" CssClass="save-btn" OnClick="btnSaveMember_Click" />
                    </div>
                </div>
            </div>
        </asp:Panel>
    ...
    <script>
        ...
        // Tự cập nhật preview ảnh khi nhập link
        function updatePreview() {
            const url = document.getElementById("<%= txtAvatarUrl.ClientID %>").value;
            document.getElementById("<%= imgPreview.ClientID %>").src = url;
        }

        // Gắn trigger thủ công (nếu không dùng AutoPostBack)
        document.addEventListener("DOMContentLoaded", function () {
            document.getElementById("<%= txtAvatarUrl.ClientID %>").addEventListener("input", updatePreview);
        });
    </script>
