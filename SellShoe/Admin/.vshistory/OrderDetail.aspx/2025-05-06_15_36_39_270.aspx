...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <% if (listOD[i].Status == 0) { %>
        <a href='Dash.aspx?toggle=1&id=<%=listOD[i].id %>' class='status-badge processing'>Đang xử lý</a>
    <% } else { %>
        <a href='Dash.aspx?toggle=1&id=<%=listOD[i].id %>' class='status-badge completed'>Hoàn thành</a>
    <% } %>
</td>
