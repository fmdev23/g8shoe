    ...
    <div class="content-card">
        ...
        <div class="table-container">
            ...
            <% if (listOD[i].Status == 0) { %>
                <span class="status-badge processing" onclick="location.href='Dash.aspx?toggle=1&id=<%=listOD[i].id %>'">Đang xử lý</span>
            <% } else { %>
                <span class="status-badge completed" onclick="location.href='Dash.aspx?toggle=1&id=<%=listOD[i].id %>'">Hoàn thành</span>
            <% } %>
        </td>
