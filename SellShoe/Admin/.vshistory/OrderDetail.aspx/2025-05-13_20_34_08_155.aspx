                    ...
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton runat="server"
                                ...
                                OnClientClick='<%# "return deleteOrd(\"" + Eval("Order.id") + "\");" %>'>
    ...
    <script type="text/javascript">
        function deleteOrd(id) {
            Swal.fire({
                ...
                text: 'Hành động này không thể hoàn tác! Hãy chắc chắn đây là đơn lỗi! Điều này sẽ ảnh hưởng đến doanh thu.',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'OrderDetail.aspx?deleteId=' + Order.id;
                }
            });
