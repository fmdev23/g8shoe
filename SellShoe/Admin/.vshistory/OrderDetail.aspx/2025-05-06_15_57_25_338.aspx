<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderDetail.aspx.cs" Inherits="SellShoe.Admin.OrderDetail" EnablePageMethods="true" %>
            ...
            <table class="products-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <% if (listOD[i].Status == 0)
                                { %>
                            <span class="status-badge processing" onclick="location.href='OrderDetail.aspx?toggle=1&id=<%=listOD[i].id %>'">Đang xử lý</span>
                            <% }
                            else
                            { %>
                            <span class="status-badge completed" onclick="location.href='OrderDetail.aspx?toggle=1&id=<%=listOD[i].id %>'">Hoàn thành</span>
                            <% } %>
                        </td>
