    ...
    public partial class Product : System.Web.UI.Page
    {
        ...
        protected void dgProducts_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "EditProduct")
            {
                ...
                var product = YourDataAccessLayer.GetProductById(id); // Đổi tên theo project của bạn
                ...
                if (product != null)
                {
                    ...
                    // Gọi script để hiển thị modal
                    ScriptManager.RegisterStartupScript(this, GetType(), "ShowModal", "$('#productModal').modal('show');", true);
                }
            }
        }
