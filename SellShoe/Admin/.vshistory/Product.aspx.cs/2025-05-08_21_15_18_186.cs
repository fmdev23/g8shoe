    ...
    public partial class Product : System.Web.UI.Page
    {
        ...
        protected void rptProducts_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                ...
                // TODO: Load product info by id, fill modal fields using JS or server-side binding
            }
            else if (e.CommandName == "Delete")
            {
                int id = Convert.ToInt32(e.CommandArgument);
                // TODO: Thực hiện xóa sản phẩm từ DB bằng LINQ to SQL hoặc ADO.NET
                // Sau đó reload dữ liệu:
                LoadProducts(); // Hàm load lại danh sách sản phẩm
            }
        }
