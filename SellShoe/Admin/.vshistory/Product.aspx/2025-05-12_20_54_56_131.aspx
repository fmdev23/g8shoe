        ...
        <div class="table-container">
            <asp:DataGrid ID="dgProducts" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundColumn HeaderText="Tên SP" DataField="Title" />
                    <asp:BoundColumn HeaderText="Mã SP" DataField="ProductCode" />
                    <asp:TemplateColumn HeaderText="Giá hiển thị">
                        <ItemTemplate>
                            <%# string.Format("{0:N0}", Eval("PriceSale")).Replace(",", ".") %>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:BoundColumn HeaderText="Số lượng" DataField="Quantity" />
                    ...
                    <asp:TemplateColumn HeaderText="Tùy chọn">
                        <ItemTemplate>
                            <div class="action-menu">
                                <button type="button" class="action-btn"><i class="fad fa-edit"></i></button>
                                <button type="button" class="action-btn"><i class="fal fa-trash"></i></button>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
