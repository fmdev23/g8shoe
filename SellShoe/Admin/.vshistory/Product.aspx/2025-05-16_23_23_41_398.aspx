        ...
        <div class="card-header">
            ...
            <div class="header-actions">
                <div class="search-container">
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="search-input" placeholder="Tìm sản phẩm..." />
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            searchInput.addEventListener('input', () => {
                ...
                const rows = dataGrid.querySelectorAll('tbody tr'); // chọn body rows để tránh header
