        ...
        <div class="table-container">
            <asp:DataGrid ID="dgProducts" runat="server"
                ...
                <Columns>
                    ...
                    <%-- Các cột boolean --%>
                    <asp:TemplateColumn HeaderText="Best Seller">
                        <ItemTemplate><%# Eval("IsHot") %></ItemTemplate>
                        <EditItemTemplate>
                            <asp:CheckBox ID="chkIsHot" runat="server" Checked='<%# Bind("IsHot") %>' />
                        </EditItemTemplate>
                    </asp:TemplateColumn>

                    <asp:TemplateColumn HeaderText="SP Mới">
