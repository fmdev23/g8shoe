    ...
    <script>
        ...
        function saveProduct() {
            const product = {
                ...
                priceSale: parseFloat(document.getElementById("productPriceSale").value) || 0,
                ...
                productCategoryId: parseInt(document.getElementById("productCategory").value) || 0,
                ...
                alias: document.getElementById("productAlias").value
            };
        ...
        // Hàm nạp dữ liệu sản phẩm vào form để chỉnh sửa
        function editProduct(product) {
            ...
            document.getElementById("productPriceSale").value = product.priceSale;
            ...
            document.getElementById("productCategory").value = product.productCategoryId;
            ...
            document.getElementById("seoKeywords").value = product.seoKeywords;
