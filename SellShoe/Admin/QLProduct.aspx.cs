...
namespace SellShoe.Admin
{
    public partial class QL_Product : System.Web.UI.Page
    {
        ...
        protected void btnAddProduct_Click(object sender, EventArgs e)
        {
            ...
            // Mở modal bằng cách gọi JavaScript showAddModal()
            ScriptManager.RegisterStartupScript(this, this.GetType(), "showModal", "showAddModal();", true);
        }
        ...
        protected void btnSaveProduct_Click(object sender, EventArgs e) // Xử lý sự kiện khi nhấn nút lưu sản phẩm
        {
            ...
            try
            {
                ...
                if (fuImage.HasFile) // Kiểm tra xem có tệp hình ảnh được tải lên không
                {
                    ...
                    string filePath = productFolder + DateTime.Now.Ticks + "_" + fileName; // Tạo đường dẫn tệp với ngày giờ hiện tại để tránh trùng lặp
                ...
                if (productId == 0) // Nếu ID sản phẩm là 0, tức là đang thêm mới sản phẩm
                {
                    ...
                    var sp = new tb_Product
                    {
                        ...
                        Image = imagePath,
                        Price = string.IsNullOrWhiteSpace(txtPrice.Text) ? 0 : decimal.Parse(txtPrice.Text), // Gán giá sản phẩm, nếu ô nhập liệu rỗng thì gán là 0
        ...
        [WebMethod]
        public static ProductData GetProductById(int id) // Lấy thông tin sản phẩm theo ID
        {
        ...
        private string SearchKeyword // Thuộc tính để lưu từ khóa tìm kiếm trong ViewState
        {
